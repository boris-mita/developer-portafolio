...
export default async function Experience() {
  ...
  return (
    // 1. Quitamos 'overflow-hidden' del padre principal para permitir el brillo de GlowCard
    <div id="experience" className="relative px-3 py-0">
      {/* 2. Encapsulamos la imagen en un div absoluto recortado solo arriba */}
      <div className="absolute inset-x-0 top-0 h-full overflow-hidden pointer-events-none">
        <Image
          ...
          width={1572}
          height={795}
          className="absolute -top-[98px] left-1/2 -translate-x-1/2 z-1"
        />
      </div>
